...
//                    new MianMenu(Name).setVisible(true);
    ...
    private void ShowOrders()
    {
        ...
        {
            int i = 0;
            String select1 = "SELECT * FROM Orders WHERE cust_email = ?";
           ...
           @Override
            public void actionPerformed(ActionEvent evt) {
                ...
                try
                {
                    ...
                    pst2.execute();
                    pst2.close();
                    JOptionPane.showMessageDialog(null, "Order Deleted", "Alert", JOptionPane.INFORMATION_MESSAGE);
